...
* id = "5748-delivery"
* contained[0] = SD-5748-delivery-JsonExample-Riedl_404839-ContainedInventory
* meta.versionId = "1"
...
* suppliedItem[0].itemReference = Reference(SD-5748-delivery-JsonExample-Riedl_404839-ContainedInventory)
...
Instance: SD-5748-delivery-JsonExample-Riedl_404839-ContainedInventory
...
* netContent = 10 http://example.org/CodeSystem/eahp-logistics-unit-cs#indivisible-logistical-unit "Indivisible Logistical Unit"
